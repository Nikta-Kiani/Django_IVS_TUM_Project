...
class ConfigurationInfo(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='configuration', help_text="The user who created this entry.")
    ...
    update_date = models.DateField(null=False, help_text="The updated Date.")
    ...
    CDP_occupation_code = models.IntegerField(blank=False, null=False, help_text="CDP occupation code.")
    CDP_monument_number = models.IntegerField(blank=False, null=False, help_text="CDP monument number.")
    ...
    start_date_of_operation = models.DateField(null=False, help_text="The start date of configuration operation.")
    ...
    most_recent_survey_date = models.DateField(null=False, help_text="The most recent survey date.")
    ...
    diameter_m = models.FloatField(null=False, help_text="Diameter of the antenna in meters.")
    ...
    start_date_of_occupation = models.DateField(null=False, help_text="The start date of occupation.")
    end_date_of_occupation = models.DateField(null=False, help_text="The end date of occupation.")
    additional_info = models.TextField(blank=True, null=True, help_text="Additional information or comments (optional).")
    ...
    x_bandwidth_mhz = models.FloatField(null=False, help_text="X bandwidth in MHz.")
    s_bandwidth_mhz = models.FloatField(null=False, help_text="S bandwidth in MHz.")
    x_tsys_at_zenith_k = models.FloatField(null=False, help_text="X Tsys at zenith in K.")
    s_tsys_at_zenith_k = models.FloatField(null=False, help_text="S Tsys at zenith in K.")
    x_sefd_jy = models.FloatField(null=False, help_text="X SEFD in Jy.")
    s_sefd_jy = models.FloatField(null=False, help_text="S SEFD in Jy.")
    ...
    x_lo_frequencies_mhz = models.FloatField(null=False, help_text="X LO frequencies in MHz.")
    s_lo_frequencies_mhz = models.FloatField(null=False, help_text="S LO frequencies in MHz.")
    ...
    length_of_cable_run_m = models.FloatField(null=False, help_text="Length of cable run in meters.")
    ...
    phase_cal_ref_signal_freq_mhz = models.FloatField(null=False, help_text="Phase cal ref signal frequency in MHz.")
    ...
    number_of_mixers = models.IntegerField(null=False, help_text="Number of mixers in video converter set.")
    sidebands_available = models.CharField(max_length=150, help_text="Mention the set's available sidebands.")
    number_of_mixers_with_2mhz_filter = models.IntegerField(null=False, help_text="Number of mixers with 2 MHz filter in all sideband outputs.")
    number_of_mixers_with_4mhz_filter = models.IntegerField(null=False, help_text="Number of mixers with 4 MHz filter in all sideband outputs.")
    number_of_mixers_with_8mhz_filter = models.IntegerField(null=False, help_text="Number of mixers with 8 MHz filter in all sideband outputs.")
    number_of_mixers_with_16mhz_filter = models.IntegerField(null=False, help_text="Number of mixers with 16 MHz filter in all sideband outputs.")
    number_of_mixers_with_32mhz_filter = models.IntegerField(null=False, help_text="Number of mixers with 32 MHz filter in all sideband outputs.")
    ...
    X_down_converter_freq = models.FloatField(null=False, help_text="X down converter frequency in MHz.")
    ...
    number_of_recorders = models.IntegerField(null=False, help_text="Number of recorders.")
    ...
    pressure_sensor_height_relative_to_VLBI_in_meters = models.FloatField(null=False, help_text="Mention the height relative to VLBI in meters.")
    ...
    computer_CPU_speed_in_MHz = models.FloatField(null=False, help_text = "Mention the computer's CPU speed in MHz.")
    computer_memory_in_Mbytes = models.FloatField(null=False, help_text = "Mention the computer's memory in Mbytes.")
    computer_disk_in_Gbytes = models.FloatField(null=False, help_text = "Mention the computer's disk in Gbytes.")
